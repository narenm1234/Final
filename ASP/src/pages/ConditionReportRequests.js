...
import MileagePricingSideBar from '../components/MileagePricingSideBar';
...
export default function ConditionReportRequests(props) {
  ...
  // console.log("pageName:", props?.location?.state?.pageName)
  // console.log("vin:",props?.location?.state?.vin)
    ...
    <>
      ...
      <Box mt={2}>
        ...
        <Box display={'flex'} width={'100%'} >
          <Box className="conditional-report-body">
            <Grid container spacing={3}>
              ...
              <Grid item xs={5}>
                {condionVehicleDetails && Object.keys(condionVehicleDetails).length ? <MyGallery {...condionVehicleDetails} /> : null}
                <Grid container className="ConditionCardBody">
                  ...
                  <Grid className="center-aligin-btn" mt={2} mb={2} item xs={12}>
                    <Button
                      variant="outlined"
                      color="primary"
          ...
          <Box className="right-sidebar">
            {pageName === 'Manual Pricing' ? <ManualPricingSideBar vin={vin} /> : null}
            {pageName === 'Mileage Discrepencies' ? <MileagePricingSideBar vin={vin} /> : null}
          </Box>
        </Box>
